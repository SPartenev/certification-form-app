...
const translations = {
  bg: {
    ...
    'iso37001.processesOutOfScope': 'Има ли процеси и/или дейности, извън обхвата на сертификацията. Ако "да", посочете кои и аргументите да не бъдат включени.',
    'iso37001.countries': 'Държава/-и, в които се осъществяват дейностите (Не е обвързано само с площадката. Например от офис в България могат да бъдат обслужвани клиенти в различни държави).',
    'iso37001.requirements': 'Посочете приложими нормативни изисквания, договорни и професионални ангажименти и задължения (напр. нормативни изисквания за законното упражняване на дейността и доказателства, че са изпълнени – номер на лиценз, разрешително, връзка към публичен регистър; дългосрочни договори в изпълнение – напр. такива, които имат още поне две години срок за изпълнение).',
    ...
    'iso37001.siteAddress': 'Адрес на площадката',
    'iso37001.siteType': 'Вид площадката (напр. централен офис, търговски офис, др.)',
    'iso37001.sensitiveProcesses': 'Чувствителни процеси',
    'iso37001.totalEmployees': 'Общ брой на персонала в процеси с висок риск от подкупване',
    'iso37001.totalEmployeesHelp': 'Общият брой от секцията „Чувствителни процеси" по-долу',
    'iso37001.publicRevenue': 'Приблизителен процент от приходите през последната приключена финансова година, които са от публични източници? %',
    ...
    'iso37001.independentVerification': 'Съгласно изискванията за сертификация при прегледа на Вашата заявка органът за сертификация е длъжен да направи своя независима проверка на подадената в заявката информация от публични източници. При възникнали въпроси или необходимост от допълнителна информация представител на органа за сертификация ще се свърже с Вас.',
    ...
    'transfer.validCertificate': 'Валиден ли е сертификатът, който е обект на трансфер (включително валидността му не е била прекратена от органа за сертификация)?',
    ...
    'transfer.requirements': 'Нормативни изисквания, които ви задължават да притежавате валиден сертификат? Ако "да", моля опишете.',
    ...
    // ISO 45001 section
    'iso45001.title': 'Безопасност и здраве при работа',
    'iso45001.subtitle': 'Безопасност и здраве при работа',
    
    // ISO 45001 questions
    'iso45001.question1': 'Основни опасности и рискове за здравето и безопасността при работа, свързани с дейността',
    'iso45001.question2': 'Използвате ли опасни химически вещества и смеси в дейността си? Ако "да", моля посочете какви.',
    'iso45001.question3': 'Използвате ли инсталации и/или СПО по смисъла на националното законодателство? Ако "да", моля разяснете.',
    'iso45001.question4': 'Приложими нормативни изисквания, свързани с БЗР. Моля посочете.',
    'iso45001.question5': 'Персонал, който работи извън площадката (напр. шофьори, монтажници и др.), или на временни площадки? Моля пояснете и посочете приблизителен брой.',
    'iso45001.question6': 'През последните две години регистрирани ли са трудови злополуки? Ако "да", моля разяснете.',
    'iso45001.question7': 'Водят ли се срещу вас съдебни дела за нарушаване на трудовото законодателство и/или по БЗР? Ако "да", моля разяснете.',
    ...
    // ISO 14001 questions
    'iso14001.question1': 'Значими аспекти на околната среда и свързаните с тях процеси',
    'iso14001.question2': 'Дейността извършва ли се в населено място или индустриална зона, селски район или защитена територия? Моля дайте пояснение.',
    'iso14001.question3': 'Приложими нормативни изисквания и лицензи и разрешителни за управлението на околната среда. Моля посочете.',
    'iso14001.question4': 'Има "непреки" аспекти на околната среда (напр. услуги за проектиране)? Моля опишете накратко.',
    'iso14001.question5': 'Рискове от значими екологични щети в резултат от съхранение на материали или използването им? Моля опишете накратко.',
    ...
    // ISO 27001 section
    'iso27001.title': 'Сигурност на информацията',
    'iso27001.subtitle': 'Сигурност на информацията',
    ...
    'iso27001.access.readonly': 'Достъп само за четене: Служители с достъп единствено за четене на информацията, необходима за изпълнение на техните задължения.',
    'iso27001.access.nophysical': 'Без физически достъп: Лица, които нямат достъп до съоръженията за обработка на информация, включени в обхвата на СУСИ.',
    'iso27001.access.limited': 'Ограничен достъп: Лица, които имат специфичен, демонстриран ограничен достъп до съоръженията.',
    'iso27001.access.full': 'Пълен достъп и стриктни ограничения: Лица с наложени ограничения за предотвратяване на разкриването на информация.',
    ...
    // ISO 22000 questions
    'iso22000.haccpPlans': 'Брой HACCP планове със съответните им имена за всяка площадка в обхвата на сертификация, вкл. опасностите във всеки HACCP план',
    'iso22000.description': 'Описание на продукти и процеси, продуктови линии, персонал, вид и разнообразие на задачите, които засягат БХП, разработване на продукти, собствени лабораторни изпитвания и др.',
    'iso22000.automation': 'Информация за ниво на автоматизация, използване на затворени производствени системи, други технологии, механизация, ръчен труд',
    
    // ISO 39001 section
    'iso39001.title': 'Безопасност на движение',
    'iso39001.subtitle': 'Безопасност на движение',
  ...
  en: {
    ...
    'processes.operationalControl': 'Operational control and accountability',
    'processes.distributionManagement': 'Management of distribution/sales networks',
    'processes.tendering': 'Conducting tender procedures and selection of suppliers',
    ...
    'processes.institutionalContact': 'Maintaining contact with institutions and regulatory authorities',
