...
const translations = {
  bg: {
    ...
    'processes.other1': 'Друго (добавете допълнителни редове при необходимост)',
    ...
    'iso27001.access.readonly': 'Достъп само за четене: Служители с достъп единствено за четене на информацията, необходима за изпълнение на техните задължения. Брой в категорията и коментар',
    'iso27001.access.nophysical': 'Без физически достъп: Лица, които нямат достъп до съоръженията за обработка на информация, включени в обхвата на СУСИ. Брой в категорията и коментар',
    'iso27001.access.limited': 'Ограничен достъп: Лица, които имат специфичен, демонстриран ограничен достъп до съоръженията. Брой в категорията и коментар',
    'iso27001.access.full': 'Пълен достъп и стриктни ограничения: Лица с наложени ограничения за предотвратяване на разкриването на информация. Брой в категорията и коментар',
