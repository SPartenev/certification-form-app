...
const translations = {
  ...
  en: {
    ...
    'multiSite.description': 'Please mark which of the following statements apply to your management system',
    'multiSite.option1': 'Central management has full control over all sites',
    'multiSite.option2': 'All sites use the same management system',
    'multiSite.option3': 'All sites are certified to the same standard',
    'multiSite.option4': 'All sites are under the same legal structure',
